...
def main(args):
    ...
    loss_fnc = nn.CrossEntropyLoss().to(args.local_rank)
    ...
    for epoch in range(args.n_epochs):
        ...
        if (epoch+1) % args.eval_epoch == 0:
            if dist.get_rank() == 0:
                save_path = os.path.join(args.save_dir,'model_Epoch%d_Loss%.2f_.bin'%(epoch,epoch_loss))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", default='checkpoint_DDP', type=str)
